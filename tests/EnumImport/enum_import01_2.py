...
class Type01_1(GeneratedsSuper):
    member_data_items_ = {
        'username': MemberSpec_('username', 'xs:string', 0, 0, {u'type': u'xs:string', u'name': u'username'}, None),
        'inner01': MemberSpec_('inner01', 'Type02_1', 0, 0, {u'type': u'Type02_1', u'name': u'inner01'}, None),
    }
    subclass = None
    superclass = None
